...
<input type="hidden" class="form-control" id="map_key" value="<?=$map_key?>" >
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="service_amount" id="service_amount" value="<?php echo $service_amount . currency_conversion($user_currency_code) ;  ?>" readonly="">
                            </div>
                        </div>
