    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="popular-slider owl-carousel owl-theme">
                        ...
                        foreach ($popular_service as $key => $serv) {
                            ...
                            If (!empty($userId)) {
                                ...
                                $service_amount12 = get_gigs_currency($serv['service_amount'], settings('currency'), settings('currency'));
                            } else {
                                $user_currency_code = settings('currency');
                                $service_amount12 = get_gigs_currency($serv['service_amount'],  settings('currency'),  settings('currency'));
                            }
            ...
            If (!empty($userId)) {
                ...
                $service_amount = get_gigs_currency($service['service_amount'],  settings('currency'), $user_currency_code);
            } else {
                $user_currency_code = settings('currency');
                $service_currency_code =  settings('currency');
                $service_amount = get_gigs_currency($service['service_amount'],  settings('currency'), $user_currency_code);
            }
            ?>
            <div class="col-lg-4 theiaStickySidebar">
                <div class="sidebar-widget widget">
                    <div class="service-amount">
                        <span><?php echo $service_amount . currency_conversion($user_currency_code) ;  ?></span>
                    </div>
