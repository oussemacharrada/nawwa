                            ...
                            <form action="<?php echo base_url(); ?>search" id="search_service" method="post">
                                ...
                                <div class="search-input line">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="text" class="form-control common_search" name="common_search" id="search-blk" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_search_palaceholder'])) ? $user_language[$user_selected]['lg_search_palaceholder'] : $default_language['en']['lg_search_palaceholder']; ?>" >
                                    </div>
                                </div>
                                <div class="search-input">
                                    <i class="fas fa-location-arrow bficon"></i>
                                    <div class="form-group mb-0">
                                        <input type="text" class="form-control" value="" name="user_address" id="user_address" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_search_location_palaceholder'])) ? $user_language[$user_selected]['lg_search_location_palaceholder'] : $default_language['en']['lg_search_location_palaceholder']; ?>">
                    ...
                    <div class="row">
                        ...
                        if (!empty($category)) {
                            foreach ($category as $crows) {
                                ?>
                                <div class="col-lg-4 col-md-6 fade-in appear" data-aos="fade-up">
...
//                                print_r($srows);exit;
                                ...
                                If (!empty($userId)) {
                                    ...
                                    $service_amount = get_gigs_currency($srows['service_amount'], settings('currency'), $user_currency_code);
                                } else {
                                    $user_currency_code = settings('currency');
...
//                               
                                ?>
                                <div class="service-widget " data-aos="fade-up">
        ...
        <?php } ?>
                                                ...
                                                <span class="service-price"><?php echo $service_amount . currency_conversion($user_currency_code) ;  ?></span>
                                            </div>
                                            <div class="cate-list">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up">
                ...
                <div class="howworksec" data-aos="fade-up">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="howwork">
                                <div class="iconround">
