                                    ...
                                    <div class="booking-widget">
                                        ...
                                        <div class="booking-det-info">
                                            ...
                                            If (!empty($userId)) {
                                                ...
                                                $service_amount = get_gigs_currency($bookings['amount'],  settings('currency'), $user_currency_code);
                                            } else {
                                                $user_currency_code = settings('currency');
                                                $service_amount = $bookings['amount'];
                                            }
                                            ...
                                            <ul class="booking-details">
                                                ...
                                                <li><span><?php echo (!empty($user_language[$user_selected]['lg_Amount'])) ? $user_language[$user_selected]['lg_Amount'] : $default_language['en']['lg_Amount']; ?></span> <?php echo $service_amount . currency_conversion($user_currency_code) ;  ?></li>
