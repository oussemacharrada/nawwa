                                    ...
                                    <div class="booking-widget">
                                        ...
                                        <div class="booking-det-info">
                                            ...
                                            If (!empty($userId)) {
                                                ...
                                                $service_amount1 = get_gigs_currency($bookings['amount'],  settings('currency'),  settings('currency'));
//                                           print_r($service_amount1);exit;
                                            ...
                                            <ul class="booking-details">
                                                ...
                                                <li><span><?php echo (!empty($user_language[$user_selected]['lg_Amount'])) ? $user_language[$user_selected]['lg_Amount'] : $default_language['en']['lg_Amount']; ?></span> <?php echo $service_amount1 . currency_conversion($user_currency_code) ;  ?></li>
